...
describe('evaluateHand', () => {
  ...
  describe('TWO_PAIR', () => {
    it('detects two pair', () => {
      const hand = [c('A', 'H'), c('A', 'D'), c('K', 'C'), c('K', 'S'), c('J', 'H')];
  ...
  describe('THREE_OF_A_KIND', () => {
    it('detects three of a kind', () => {
      const hand = [c('A', 'H'), c('A', 'D'), c('A', 'C'), c('K', 'S'), c('J', 'H')];
  ...
  describe('STRAIGHT', () => {
    ...
    it('detects A-low straight (wheel: A-2-3-4-5)', () => {
      const hand = [c('A', 'H'), c('2', 'D'), c('3', 'C'), c('4', 'S'), c('5', 'H')];
      expect(evaluateHand(hand).category).toBe(HandCategory.STRAIGHT);
    });
  ...
  describe('FLUSH', () => {
    it('detects flush', () => {
      const hand = [c('A', 'H'), c('K', 'H'), c('Q', 'H'), c('J', 'H'), c('9', 'H')];
  ...
  describe('FULL_HOUSE', () => {
    it('detects full house', () => {
      const hand = [c('A', 'H'), c('A', 'D'), c('A', 'C'), c('K', 'S'), c('K', 'H')];
  ...
  describe('FOUR_OF_A_KIND', () => {
    it('detects four of a kind', () => {
      const hand = [c('A', 'H'), c('A', 'D'), c('A', 'C'), c('A', 'S'), c('K', 'H')];
